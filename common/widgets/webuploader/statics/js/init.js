    ...
    $.fn.webupload_fileinput = function (config) {
        ...
        function buildModalBody () {
            return '<ul class="nav nav-upfile">\
        					...
        					<li class=""><a href="#tab-upfile3" data-toggle="tab" aria-expanded="false" onclick="set_frame(\'album_list\',\'index.php?r=attachment/album&modal='+config['modal_id']+'\');">在线管理</a></li>\
        				</ul>\
