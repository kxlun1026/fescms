...
class SignupForm extends Model
{
    ...
    {
        return [
            self::SCENARIO_STUDENT => ['type', 'username', 'password', 'email', 'mobile', 'fullname', 'sex', 'province', 'city', 'town', 'school', 'college', 'profession', 'class', 'address', 'postcode'],
            self::SCENARIO_TEACHER => ['type', 'username', 'password', 'email', 'mobile', 'fullname', 'sex', 'province', 'city', 'town', 'company', 'teaching', 'address', 'postcode'],
        ];
    }
