	...
	<div class="row justify-content-center">
		<div class="col-md-6">
		   <?php if (Yii::$app->request->get('type')){?>
			<?php $form = ActiveForm::begin(['id' => 'form-signup', 'options' => ['class' => 'signup-form shadow-sm'],'enableClientScript' => false,]); ?>
				...
				<?= $form->field($model, 'username')->textInput(['autofocus' => true, 'placeholder' => '2-20个字符，可由中文、英文、数字和‘_’组成']) ?>
...
<p class="help-block help-block-error"></p>
				...
				<p class="mt-4 text-center">已经有一个帐号？ 点击立即<?= Html::a('登录', ['site/login']) ?></p>
			<?php ActiveForm::end(); ?>
			<?php }else{?>
			<div class="signup-form shadow-sm m-5">
			    <div class="login-head">
			    	<h2>选择注册的账号类型</h2>
