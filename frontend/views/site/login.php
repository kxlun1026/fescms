...
<div class="container py-5">
	<div class="row justify-content-center">
		<div class="col-md-6">
			<?php $form = ActiveForm::begin(['id' => 'login-form', 'options' => ['class' => 'login-form shadow-sm'],'enableClientScript' => false,]); ?>
				...
				<p class="mt-4 text-center">还没账号？ 点击立即<?= Html::a('注册', ['site/signup']) ?></p>
			<?php ActiveForm::end(); ?>
