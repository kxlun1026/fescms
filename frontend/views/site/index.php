...
<section class="banner-section">
			<div class="home-carousel owl-theme owl-carousel">
				<div class="slide-item">
					<div class="image-layer" data-background="<?= Url::to('@web/statics/images/bg/1.jpg') ?>"></div>
					<div class="container">
						<div class="row">
				...
				<div class="slide-item">
					<div class="image-layer" data-background="<?= Url::to('@web/statics/images/bg/2.jpg') ?>"></div>
					<div class="container">
				...
				<div class="slide-item">
					<div class="image-layer" data-background="<?= Url::to('@web/statics/images/bg/3.jpg') ?>"></div>
					<div class="container">
						<div class="row clearfix">
							<div class="col-xl-8 col-lg-12 col-md-12 content-column">
								<div class="content-box">
				...
				<div class="row">
					<div class="video-column col-md-6">
						<div class="inner-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
							<!--Video Box-->
							<div class="video-box">
								<figure class="image"><img class="img-fluid" src="<?= Url::to('@web/statics/images/video-image.jpg') ?>"></figure>
							</div>
						</div>
					</div><!-- Content Column -->
