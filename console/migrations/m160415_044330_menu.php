    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%menu}}', ['id', 'name', 'parentid', 'route', 'data', 'icon', 'sort', 'display'], 
            [
                ...
                ['76', '导出EXCEL', '74', '/contest/excel', '', '', '0', '0'],
                ['77', '审核报名信息', '74', '/contest/verify', '', '', '0', '0'],
                ['78', '删除报名信息', '74', '/contest/delete', '', '', '0', '0'],
                ['79', '清空报名数据', '74', '/contest/initdata', '', '', '0', '0'],
                ['80', '分组管理', '6', '/contest-type/index', '', '', '0', '1'],
                ['81', '添加分组', '80', '/contest-type/create', '', '', '0', '0'],
                ['82', '修改分组', '80', '/contest-type/update', '', '', '0', '0'],
                ['83', '删除分组', '80', '/contest-type/delete', '', '', '0', '0'],
            ]);
